...
export function nav(_activePath = '/'): string {
  return `
  <nav class="nav">
  ...
  <section class="hero">
    <div class="container">
      ...
      <div class="og-preview-wrap" style="margin-top:56px;">
        ...
        <img
          src="/og?key=demo&theme=dark&template=default"
  ...
  <section class="section">
    <div class="container" style="max-width:480px;">
      ...
      ${tier === 'pro' || tier === 'business'
        ? `<div class="alert" style="border:1px solid var(--accent-dim);color:var(--text-2);padding:12px 16px;border-radius:8px;margin-bottom:20px;">
            Paid checkout is launching soon. You'll start on the free tier (100 images/month) and can upgrade from your dashboard once billing is live.
          </div>`
        : ''}
...
export function keyCreatedPage(rawKey: string, email: string, tier: string, origin: string): string {
  const body = `
  ${nav()}
  <section class="section">
